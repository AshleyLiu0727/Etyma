...
import UserSeivice from '../../services/UserSeivice';
/* 以类的方式创建一个组件 */
		...
		return (
          ...
          <QueueAnim delay={0} className="queue-simple" type={['right', 'left']}>
            <div key="a">
              ...
              <Table columns={columns} dataSource={userData} pagination={false} size="middle" />
            </div>
            <div key="b">
              <Pagination style={{marginTop:10,marginBottom:10}} showSizeChanger onChange={self.PaginationOnChange} defaultCurrent={1} total={total} className="Pagination"/>
            </div>
      		</QueueAnim>
    		</div>
		);
